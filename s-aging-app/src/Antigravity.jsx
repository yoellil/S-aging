...
const AntigravityInner = ({
  ...
  const bananaTexture = useLoader(THREE.TextureLoader, '/banana-pix.png');
  ...
  return (
    <instancedMesh ref={meshRef} args={[undefined, undefined, count]}>
      ...
      <meshBasicMaterial map={bananaTexture} transparent alphaTest={0.1} />
    </instancedMesh>
  );
};

export default function Antigravity({ visible = true, ...props }) {
  ...
  return (
    <div style={{
      ...
      <Canvas camera={{ position: [0, 0, 50], fov: 35 }}>
        <AntigravityInner autoAnimate {...props} />
      </Canvas>
    </div>
  );
}
